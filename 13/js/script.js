...
const getCorrectUrl = (imgName) => IMAGES_PATH + imgName;

const IMAGES_URLS = Object.freeze({
  plane: getCorrectUrl(`airplane.png`),
  tree: getCorrectUrl(`tree.png`),
  tree2: getCorrectUrl(`tree-2.png`),
  ice: getCorrectUrl(`ice.png`),
  seaCalf: getCorrectUrl(`sea-calf-2.png`),
  snowflake: getCorrectUrl(`snowflake.png`)
});
...
/* harmony import */ var _prize_count_animation_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./prize-count-animation.js */ "./source/js/modules/prize-count-animation.js");
...
class FullPageScroll {
  ...
  changeVisibilityDisplay() {
    ...
    if (this.activeScreen === this.GAME_SCREEN_INDEX) {
      Object(_timer_js__WEBPACK_IMPORTED_MODULE_1__["default"])(this.GAMER_TIMER_INITIAL_VALUE);
    }

    if (this.previousScreen === this.GAME_SCREEN_INDEX) {
      Object(_timer_js__WEBPACK_IMPORTED_MODULE_1__["clearTimer"])(this.GAMER_TIMER_INITIAL_VALUE);
    }

    if (this.activeScreen === this.PRIZES_SCREEN_INDEX) {
      if (!this.prizeAnimationStart) {
        this.prizeAnimationStart = true;
        const prizesAnimation = new _prize_count_animation_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
...
/***/ "./source/js/modules/on-load-body.js":
/*!*******************************************!*\
  !*** ./source/js/modules/on-load-body.js ***!
  \*******************************************/
/*! exports provided: default */
...
/***/ "./source/js/modules/prizes-transition-bg.js":
/*!***************************************************!*\
  !*** ./source/js/modules/prizes-transition-bg.js ***!
  \***************************************************/
/*! exports provided: default */
...
const resultScene = new _canvas_scene_2d_sea_calf_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
/*!************************************!*\
  !*** ./source/js/modules/timer.js ***!
  \************************************/
/*! exports provided: clearTimer, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const clearTimer = (sessionTimeInMinutes) => {
...
/* harmony default export */ __webpack_exports__["default"] = ((sessionTimeInMinutes = 5) => {
  const FPS = 1;
...
/* harmony import */ var _modules_on_load_body__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/on-load-body */ "./source/js/modules/on-load-body.js");
/* harmony import */ var _modules_prizes_transition_bg__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/prizes-transition-bg */ "./source/js/modules/prizes-transition-bg.js");
/* harmony import */ var _modules_text_animation_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/text-animation.js */ "./source/js/modules/text-animation.js");
// modules
...
Object(_modules_on_load_body__WEBPACK_IMPORTED_MODULE_9__["default"])();
Object(_modules_prizes_transition_bg__WEBPACK_IMPORTED_MODULE_10__["default"])();

// eslint-disable-next-line no-new
new _modules_text_animation_js__WEBPACK_IMPORTED_MODULE_11__["default"](`.animate-text`, 400);
// eslint-disable-next-line no-new
new _modules_text_animation_js__WEBPACK_IMPORTED_MODULE_11__["default"](`.intro__date`, 400, 550);
